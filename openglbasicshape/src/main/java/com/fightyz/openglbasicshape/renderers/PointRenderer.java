...
public class PointRenderer extends BaseRenderer {
    ...
    public void onSurfaceCreated(GL10 gl10, EGLConfig eglConfig) {
        ...
        String vertextShaderSource = TextResourceReader.readTextFileFromResource(mContext, R.raw.point_vertex_shader);
        String fragmentShaderSource = TextResourceReader.readTextFileFromResource(mContext, R.raw.point_fragment_shader);
        int vertexShader = ShaderHelper.compileVertexShader(vertextShaderSource);
